export default {
  ...
  glosario: [
    ...
    },
    {
      termino: 'Mercado',
      significado:
        'conjunto de consumidores identificables, con necesidades específicas, que están dispuestos a intercambiar bienes o servicios en un entorno regido por la libre oferta y demanda.',
    },
    {
      termino: 'Monopolio',
      significado:
